# Python Notebook - is_wait_prediction_v10_binary_new_loss_model_training
...
# best_params = {'penalty': 'l1', 'C': 1.524368217329709, 'l1_ratio': 0.024154891386897637, 'scaler_type': 'normal', 'threshold': 0.5530966718198468}
...
y_pred_proba_default = clf_default.predict_proba(X_test_scaled)
y_pred_default = np.where(y_pred_proba_default[:,1] > threshold, 1, 0)
print(">>> Train with default LR model")
...
print(X_train_store_id_agg.loc[X_train_store_id_agg['store_id'] == 545459, feat_hist_agg].head(10))
