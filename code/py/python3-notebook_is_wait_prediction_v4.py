# Python Notebook - is_wait_prediction_v4
...
feat_coef = dict(zip(cols,clf.coef_[0]))
feat_coef
...
for flf in flfs:
  for tip in tips:
    pred_horizon_thr = (-df_pre_calculated_value['value'] - tip*feat_coef['tip']/20000.0  - flf*feat_coef['flf']/18.0) / (feat_coef['pred_horizon'] / 7840)

    pred_horizon_thr[(pred_horizon_thr < pred_horizon_thr.quantile(.99)) & (pred_horizon_thr > pred_horizon_thr.quantile(.01))].hist(alpha=0.5)
