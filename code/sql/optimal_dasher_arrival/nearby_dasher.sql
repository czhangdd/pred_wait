...
--------------------------------------------------
------------ new optimal dasher arrival ----------
---------- from mx pickup prep time exp data -----
--------------------------------------------------
optimal_dasher_arrival_table as (
mx_pickup_exp_results as (
...
from exp_results where result = 'treatment'
...
join optimal_dasher_arrival_table odat
