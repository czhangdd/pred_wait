...
create or replace table CHIZHANG.pred_wait_final_remove_store_1012 as(
SELECT *
...
grant select on CHIZHANG.pred_wait_final_remove_store_1012 to role read_only_users;
select count(*) from CHIZHANG.pred_wait_final_remove_store_1012;